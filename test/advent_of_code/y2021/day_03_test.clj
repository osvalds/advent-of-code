(ns advent-of-code.y2021.day-03-test
  (:require [clojure.test :refer [deftest testing is]]
            [advent-of-code.y2021.day-03 :refer :all]
...
(deftest part1
  ...
  (testing "example"
    (let [expected 198]
      (is (= expected (part-1 (slurp (resource "2021/day-03-example.txt")))))))

  (testing "solution"
    (let [expected 3985686]
      (is (= expected (part-1 (slurp (resource "2021/day-03.txt"))))))))

(deftest part2
  (testing "example"
    (let [expected 230]
      (is (= expected (part-2 (slurp (resource "2021/day-03-example.txt")))))))

  (testing "solution"
    (let [expected 2555739]
      (is (= expected (part-2 (slurp (resource "2021/day-03.txt"))))))))
